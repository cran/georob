...
###################################################
### code chunk number 2: meuse-data
###################################################
...
###################################################
### code chunk number 3: meuse-zinc-eda-plot-1
###################################################
...
###################################################
### code chunk number 4: meuse-zinc-eda-plot-2
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 5: meuse-zinc-eda-plot-3
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 6: meuse-zinc-lm
###################################################
...
###################################################
### code chunk number 7: meuse-zinc-lm-resdiag
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 8: meuse-zinc-lm-res-sv-1
###################################################
getOption("SweaveHooks")[["fig"]]()
library(georob)
...
###################################################
### code chunk number 9: meuse-zinc-lm-res-sv-2
###################################################
getOption("SweaveHooks")[["fig"]]()
library(georob)
...
###################################################
### code chunk number 10: meuse-zinc-lm-res-spher
###################################################
summary(r.sv.spher)


###################################################
### code chunk number 11: meuse-zinc-georob-reml
###################################################
...
###################################################
### code chunk number 12: meuse-zinc-summary-georob-reml
###################################################
summary(r.georob.m0.spher.reml)


###################################################
### code chunk number 13: meuse-zinc-proflik-reml-scale-1a (eval = FALSE)
###################################################
...
###################################################
### code chunk number 14: meuse-zinc-proflik-reml-scale-1b
###################################################
r.prfl.m0.spher.reml.scale <- profilelogLik(r.georob.m0.spher.reml,
...
###################################################
### code chunk number 15: meuse-zinc-proflik-reml-scale-2
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 16: meuse-zinc-proflik-reml-scale-3
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 17: meuse-zinc-georob-reml-waldtest-1
###################################################
waldtest(r.georob.m0.spher.reml, .~.-ffreq)


###################################################
### code chunk number 18: meuse-zinc-georob-reml-multcomp
###################################################
library(multcomp)
...
###################################################
### code chunk number 19: meuse-zinc-georob-reml-waldtest-2
###################################################
waldtest(r.georob.m0.spher.reml, .~.+sqrt(dist):ffreq)


###################################################
### code chunk number 20: meuse-zinc-georob-reml-waldtest-3
###################################################
waldtest(r.georob.m0.spher.reml, .~.+soil)


###################################################
### code chunk number 21: meuse-zinc-georob-reml-step-1
###################################################
step(r.georob.m0.spher.reml, scope=log(zinc)~ffreq*sqrt(dist)+soil)


###################################################
### code chunk number 22: meuse-zinc-georob-reml-step-2
###################################################
step(r.georob.m0.spher.reml, scope=log(zinc)~ffreq*sqrt(dist)+soil, 
...
###################################################
### code chunk number 23: meuse-zinc-georob-ml
###################################################
...
###################################################
### code chunk number 24: meuse-zinc-georob-aic
###################################################
...
###################################################
### code chunk number 25: meuse-zinc-cv-1 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 26: meuse-zinc-cv-2
###################################################
...
###################################################
### code chunk number 27: meuse-zinc-cv-summary
###################################################
...
###################################################
### code chunk number 28: meuse-zinc-cv-plot
###################################################
getOption("SweaveHooks")[["fig"]]()
op <- par(mfrow=c(3,2))
...
###################################################
### code chunk number 29: meuse-zinc-georob-plot
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 30: meuse-zinc-meuse-grid
###################################################
data(meuse.grid)
...
###################################################
### code chunk number 31: meuse-zinc-meuse-point-Kriging
###################################################
...
###################################################
### code chunk number 32: meuse-zinc-meuse-point-Kriging-lgn
###################################################
str(r.pk)


###################################################
### code chunk number 33: meuse-zinc-point-Kriging-plot
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 34: meuse-zinc-block-Kriging
###################################################
...
###################################################
### code chunk number 35: meuse-zinc-meuse-block-Kriging-1a (eval = FALSE)
###################################################
...
###################################################
### code chunk number 36: meuse-zinc-meuse-block-Kriging-1b
###################################################
r.bk <- predict(r.georob.m1.spher.reml, newdata=meuse.blocks,
...
###################################################
### code chunk number 37: meuse-zinc-meuse-block-Kriging-2
###################################################
r.bk <- lgnpp(r.bk, newdata=meuse.grid)


###################################################
### code chunk number 38: meuse-zinc-block-Kriging-plot
###################################################
getOption("SweaveHooks")[["fig"]]()
brks <- c(25, 50, 75, 100, 150, 200, seq(500, 3500,by=500))
...
###################################################
### code chunk number 39: meuse-zinc-block-Kriging-blocks
###################################################
getOption("SweaveHooks")[["fig"]]()
## define blocks
...
###################################################
### code chunk number 40: meuse-zinc-block-Kriging-3
###################################################
...
###################################################
### code chunk number 41: <meuse-zinc-block-Kriging-4a
###################################################
...
###################################################
### code chunk number 42: meuse-zinc-block-Kriging-5
###################################################
...
###################################################
### code chunk number 43: meuse-zinc-block-Kriging-6
###################################################
r.blks@data[, c("lgn.pred", "opt.pred", "lgn.se", "opt.se")]


###################################################
### code chunk number 44: meuse-zinc-cleanup-1
###################################################
palette("default")


###################################################
### code chunk number 45: ash-data
###################################################
...
###################################################
### code chunk number 46: ash-centred-bubbleplot1
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 47: ash-coords-scatterplot
###################################################
getOption("SweaveHooks")[["fig"]]()
op <- par(mfrow=c(1,2))
...
###################################################
### code chunk number 48: ash-centerd-qqnorm
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 49: ash-lmrob
###################################################
library(robustbase)
...
###################################################
### code chunk number 50: ash-diag-lmrob
###################################################
getOption("SweaveHooks")[["fig"]]()
op <- par(mfrow=c(2,2))
...
###################################################
### code chunk number 51: ash-sv-res-lmrob-iso
###################################################
getOption("SweaveHooks")[["fig"]]()
library(georob)
...
###################################################
### code chunk number 52: ash-sv-res-lmrob-aniso
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 53: ash-georob-robust-1
###################################################
...
###################################################
### code chunk number 54: ash-summary-georob-robust-1
###################################################
summary(r.georob.m0.exp.c2)


###################################################
### code chunk number 55: ash-waldtest-quadratic-robust
###################################################
waldtest(update(r.georob.m0.exp.c2, .~.+I(x^2)+I(y^2)+I(x*y)), r.georob.m0.exp.c2)


###################################################
### code chunk number 56: ash-georob-robust-2
###################################################
r.georob.m1.exp.c2 <- update(r.georob.m0.exp.c2, .~.-y)


###################################################
### code chunk number 57: ash-summary-georob-robust-2
###################################################
r.georob.m1.exp.c2


###################################################
### code chunk number 58: ash-georob-robust-3
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 59: ash-diag-georob-robust-2-1
###################################################
getOption("SweaveHooks")[["fig"]]()
op <- par(mfrow=c(2,2))
...
###################################################
### code chunk number 60: ash-rw-georob-robust-2-1
###################################################
...
###################################################
### code chunk number 61: ash-rw-georob-robust-2-1
###################################################
...
###################################################
### code chunk number 62: ash-diag-georob-robust-2-2
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 63: ash-georob-gaussian-1
###################################################
r.georob.m1.exp.c1000 <- update(r.georob.m1.exp.c2, tuning.psi=1000)


###################################################
### code chunk number 64: ash-georob-summary-gaussian-1
###################################################
summary(r.georob.m1.exp.c1000)


###################################################
### code chunk number 65: ash-georob-gaussian-2
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 66: ash-georob-diag-gaussian-robust-2
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 67: ash-cv-georob-gaussian-robust-1 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 68: ash-cv-georob-gaussian-robust-2
###################################################
r.cv.georob.m1.exp.c2 <- cv(r.georob.m1.exp.c2, seed=1, 
...
###################################################
### code chunk number 69: ash-cv-georob-subsets
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 70: ash-summary-cv-georob-gaussian-robust
###################################################
...
###################################################
### code chunk number 71: ash-diag-cv-georob-gaussian-robust
###################################################
getOption("SweaveHooks")[["fig"]]()
op <- par(mfrow=c(3, 2))
...
###################################################
### code chunk number 72: ash-Kriging-grid
###################################################
coalash.grid <- expand.grid(x=seq(-1, 17, by=0.1),
  y=seq( -1, 24, by=0.1))
...
###################################################
### code chunk number 73: ash-pKriging-1 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 74: ash-pKriging-2
###################################################
...
###################################################
### code chunk number 75: ash-pKriging-plot-robust-gaussian-1
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 76: ash-pKriging-plot-robust-gaussian-2
###################################################
getOption("SweaveHooks")[["fig"]]()
library(lattice)
...
###################################################
### code chunk number 77: ash-Kriging-polygons
###################################################
getOption("SweaveHooks")[["fig"]]()
...
###################################################
### code chunk number 78: ash-bKriging-1
###################################################
...
###################################################
### code chunk number 79: ash-str-bKriging
###################################################
str(r.bk.m1.exp.c2, max=2)


###################################################
### code chunk number 80: ash-gKriging
###################################################
...
###################################################
### code chunk number 81: ash-bKriging-2
###################################################
...
###################################################
### code chunk number 82: ash-bKriging-plot-robust-gaussian-1
###################################################
getOption("SweaveHooks")[["fig"]]()
